/**
 * apps/mobile/src/screens/KYC/KYCUploadScreen.tsx
 *
...
// ─── Status Banner ────────────────────────────────────────────────────────────
function StatusBanner({ status, rejectionReason }: StatusBannerProps) {
...
export default function KYCUploadScreen({ navigation }: any) {
  ...
  const pickDocument = useCallback(async (source: 'camera' | 'library') => {
...
const styles = StyleSheet.create({
  ...
  statusBanner: { flexDirection: 'row', alignItems: 'flex-start', gap: 12, padding: 14, borderRadius: 12, borderWidth: 1, marginBottom: 20 },
  ...
  sourceBtn: { flex: 1, alignItems: 'center', paddingVertical: 18, borderRadius: 12, borderWidth: 1, backgroundColor: T.surface, gap: 6 },
  sourceBtnIcon: { fontSize: 28 },
  sourceBtnText: { fontSize: 13, fontWeight: '600' },
  docRow: { flexDirection: 'row', alignItems: 'center', padding: 12, backgroundColor: T.surface2, borderRadius: 10, marginBottom: 8 },
